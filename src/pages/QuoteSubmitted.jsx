...
<div className="flex flex-col items-center justify-center h-screen bg-gray-50">
    <div className="max-w-4xl w-full">
        ...
        <div className="px-4 py-8">
            <h1 className="text-4xl font-bold text-gray-800 mb-6">Thank you for your quote request, {contact_name} from {company_name}!</h1>
            <p className="text-xl text-gray-700 mb-4">We have received your request and will get back to you at {email} as soon as possible.</p>
